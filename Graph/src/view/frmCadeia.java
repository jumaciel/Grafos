 ...
 * @author Anah
 */
public class frmCadeia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Verificar Cadeia");
    ...
    private void btnConfirmarVerticeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarVerticeActionPerformed
        ...
        try {
            if (frmI == null) {
                ...
                frmI.getCadeiaOuCaminho(graph.getNodes(), graph.getEdges(), graph.getId(), graph.getEdgedefault(), "Cadeia: " + graph.verificaCadeia((String) cbVerificaOrigem.getSelectedItem(), (String) cbVerificaDestino.getSelectedItem(), 0, a));
            } else {
                frmI.setVisible(true);
            ...
            if (frmI == null) {
                ...
                frmI.getCadeiaOuCaminho(graph.getNodes(), graph.getEdges(), graph.getId(), graph.getEdgedefault(), "Cadeia: não existe");
            } else {
                frmI.setVisible(true);
                frmI.setState(frmInterface.NORMAL);
                frmI.getCadeiaOuCaminho(graph.getNodes(), graph.getEdges(), graph.getId(), graph.getEdgedefault(), "Cadeia: não existe");
...
//        cbVerificaOrigem.removeAllItems();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCadeia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
